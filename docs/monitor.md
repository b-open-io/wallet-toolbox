...
export class Monitor {
    static createDefaultWalletMonitorOptions(chain: Chain, storage: MonitorStorage, services?: WalletServices, chaintracks?: Chaintracks): MonitorOptions 
